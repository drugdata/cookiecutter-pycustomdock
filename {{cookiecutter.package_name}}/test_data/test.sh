...
python ../{{cookiecutter.package_name}}/{{cookiecutter.program_name}}_protein_prep.py --challengedata 1-get_challenge_data/celpp_weekXX_XXXX --prepdir 2-protein_prep


mkdir 3-ligand_prep
python ../{{cookiecutter.package_name}}/{{cookiecutter.program_name}}_ligand_prep.py --challengedata 1-get_challenge_data/celpp_weekXX_XXXX --prepdir 3-ligand_prep
